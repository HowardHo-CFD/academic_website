...
💡 Note that we are pretty certain a NACA0012 will stall when AOA is great than 20 degrees, which is not reflected with the bernoulli equation. Therefore, the results need to be interpred with a bucket of salt at high AOA.
